...
import 'package:homepage/Gauri/my_report.dart';
...
class _Profile_PageState extends State {
  String userName = 'shivam2707';
  String email = 'shivamkhule@gmail.com';
  String name = 'Shivam Khule';
  String bio =
      'In the heart of the city, the clock tower chimes, marking the hour with a soft echo. A gentle breeze carries the scent of blooming flowers, while the sun dips low on the horizon, painting the sky in shades of orange and pink.';
  String location = 'Maharashtra, Pune';
  int contact = 9999999999;
